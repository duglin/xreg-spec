...
`compatibility` attribute. This specification defines "compatibility" to mean
that a consumer using one Version of the schema would be able to understand
data encoded using another Version of the schema. Implementations of this
specification MAY choose to support any of the
